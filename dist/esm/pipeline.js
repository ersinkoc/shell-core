        ...
        for (let stepIndex = 0; stepIndex < this.steps.length; stepIndex++) {
            ...
            try {
                ...
                if (this.options.failFast) {
                    ...
                    throw new ShellError(`Pipeline failed at step '${step.name}': ${error instanceof Error ? error.message : String(error)}`, errorCode, 'pipeline', undefined, undefined, undefined, { step: step.name, error });
                }
            }
        }
        return currentData;
...
export class FilePipeline extends Pipeline {
    constructor(shellInstance, options = {}) {
...
export class TextPipeline extends Pipeline {
    constructor(shellInstance, options = {}) {
        super(shellInstance, options);
    }
    get shell() {
